...
/** Same accounts linked from the live actionrenovations.net site. Drives /social and the footer icons. */
export const socialLinks: SocialLink[] = [
  {
    name: 'Facebook',
    handle: 'actionrenovationsusa',
  ...
  {
    name: 'Instagram',
    handle: 'action.renovations',
    url: 'https://www.instagram.com/action.renovations/',
    blurb: 'Photos and short videos of our latest work around Morris County.',
    iconPath:
